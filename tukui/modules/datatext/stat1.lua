...
local displayNumberString = string.join("", "%s", T.ValColor, "%d|r")
local displayFloatString = string.join("", "%s", T.ValColor, "%.2f%%|r")
...
local function ShowTooltip(self)
	...
	elseif T.Role == "Melee" then
		local hit = T.myclass == "HUNTER" and GetCombatRating(CR_HIT_RANGED) or GetCombatRating(CR_HIT_MELEE)
		local hitBonus = T.myclass == "HUNTER" and GetCombatRatingBonus(CR_HIT_RANGED) or GetCombatRatingBonus(CR_HIT_MELEE)
		...
		local haste = T.myclass == "HUNTER" and GetCombatRating(CR_HASTE_RANGED) or GetCombatRating(CR_HASTE_MELEE)
		local hasteBonus = T.myclass == "HUNTER" and GetCombatRatingBonus(CR_HASTE_RANGED) or GetCombatRatingBonus(CR_HASTE_MELEE)
